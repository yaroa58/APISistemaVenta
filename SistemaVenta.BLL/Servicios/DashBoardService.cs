...
namespace SistemaVenta.BLL.Servicios
{
    public class DashBoardService:IDashboardService
    {
        ...
        // metodo para obtener resumen restar rabgo de dias y luego obetener rango de venta 
        ...
        // total de ingreso ultima semana
        private async Task<string> TotalIngresosUltimaSemana()
        {
            ...
            if (_ventaQuery.Count() > 0) 
            {
                var totalVenta = retornarVentas(_ventaQuery, -7);

                resultado = totalVenta.Select(v => v.Total).Sum(v => v.Value);
            }
        ...
        public async Task<DashBoardDTO> Resumen()
        {
            ...
            try
            {
                ...
                vmDashBoard.TotalImgresos = await TotalIngresosUltimaSemana();
