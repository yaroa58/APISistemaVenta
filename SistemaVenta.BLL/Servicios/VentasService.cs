...
namespace SistemaVenta.BLL.Servicios
{
    public class VentasService: IVentasService
    {
        ...
        public VentasService(IVentaRepository ventaRepositorio, IGenericRepository<DetalleVenta> detalleVentaRepositorio, IMapper mapper)
        {
        ...
        { //crear query generando consulta tabla de venta
            IQueryable<Venta> query = await _ventaRepositorio.Consultar();
            var ListaResultado = new List<Venta>();
            try
            { //validar la busqueda, se aplica filtro para buscar por fecha 
                if (buscarPor=="fecha")
                {
        ...
        { // creacion de qury para suspender la consulta de la tabla 
